			...
			<div id="post-body" class="metabox-holder">
				<div id="postbox-container-1" class="postbox-container">
						<div id="library_details" class="postbox ">
							<div class="handlediv"><br /></div>
							<h3 class="hndle"><span>Book Library</span></h3>
							<div class="inside">
								<?php include(plugin_dir_path(__FILE__).'Books.php'); ?>
							</div>
						</div>
				</div>
			</div>
...
function sales_console_consigners () { ?>
	<div class="wrap">
		<div id="icon-themes" class="icon32"><br></div>
		<h2>Consignment</h2>
		<div id="poststuff">
			<div id="post-body" class="metabox-holder">
				<div id="postbox-container-1" class="postbox-container">
					<div id="library_details" class="postbox ">
						<div class="handlediv"><br /></div>
						<h3 class="hndle"><span>Consigners</span></h3>
						<div class="inside">
							<?php include(plugin_dir_path(__FILE__).'consigners.php'); ?>
						</div>
					</div>
				</div>
			</div>
		...
		<div id="poststuff">
			<div id="post-body" class="metabox-holder">
				<div id="postbox-container-1" class="postbox-container">
					<div id="library_details" class="postbox ">
						<div class="handlediv"><br /></div>
						<h3 class="hndle"><span>Transactions</span></h3>
						<div class="inside">
							<?php include(plugin_dir_path(__FILE__).'transactions.php'); ?>
						</div>
					</div>
				</div>
			</div>
...
function sales_console_menu () {
	...
	add_menu_page('Sales Console', 'Sales Console', 'publish_posts', 'sales-console-admin', '', '', 6);
	...
	add_submenu_page('sales-console-admin', 'Consigners', 'Consigners', 'publish_posts', 'sales_console_consigners', 'sales_console_consigners');
	add_submenu_page('sales-console-admin', 'Transactions', 'Transactions', 'publish_posts', 'sales_console_transactions', 'sales_console_transactions');
