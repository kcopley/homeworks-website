...
[General]
    ...
    base_path       = /home8/homewot5/public_html/lib/IDS/ 
    use_base_path   = false
    
    filter_path     = /home8/homewot5/public_html/lib/IDS/default_filter.xml
    tmp_path        = /home8/homewot5/public_html/lib/tmp/
    scan_keys       = false
...
[Logging]
    ...
    ; file logging
    path            = /home8/homewot5/public_html/lib/IDS/tmp/phpids_log.txt

    ; email logging

    ; note that enabling safemode you can prevent spam attempts,
    ; see documentation
    recipients[]    = mikerametta@gmail.com
...
[Caching]
    ...
    ; file cache    
    path            = /home8/homewot5/public_html/lib/IDS/tmp/tmp/default_filter.cache
