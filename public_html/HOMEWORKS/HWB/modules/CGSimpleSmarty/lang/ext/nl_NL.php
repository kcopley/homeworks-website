...
<li><strong>get_page_type</strong>([$alias][,$assign])
    <p>Returns the menutext of the specified content object (by alias)</p>
    <p>Arguments:
       <ul>
       <li>[$alias] - (optional) The page alias to find the title of.  If no value is specified, the current page is used.</li>
       <li>[$assign]   - (optional) The name of a variable to assign the results to.</li>
...
<li><strong>get_page_content</strong>($alias[,$block][,$assign])
    ...
    <br/></p>
    <p>Example:<br/>
    <pre>The &#039;second&#039; block of the &#039;about&#039; page is {$cgsimple-&amp;gt;get_page_content(&#039;about&#039;,&#039;second&#039;,&#039;foo&#039;)}{eval var=$foo}</pre><br/>
    </p>
</li>
...
<p>Copyright (C) 2008, Robert Campbel <a href="mailto:calguy1000@cmsmadesimple.org">&amp;lt;calguy1000@cmsmadesimple.org&amp;gt;</a>. All Rights Are Reserved.</p>
...
$lang['utma'] = '156861353.509382990.1276370458.1277480834.1277483734.76';
$lang['utmz'] = '156861353.1277192240.63.10.utmcsr=dev.cmsmadesimple.org|utmccn=(referral)|utmcmd=referral|utmcct=/';
$lang['qca'] = 'P0-26515958-1276370458481';
$lang['utmb'] = '156861353.2.10.1277483734';
$lang['utmc'] = '156861353';
?>