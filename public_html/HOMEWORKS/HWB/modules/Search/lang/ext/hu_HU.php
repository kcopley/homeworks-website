<?php
$lang['search_method'] = 'Pretty Url kompatibilit&aacute;s POST met&oacute;duson kereszt&uuml;l. Az alap&eacute;rtelmezett met&oacute;dus mindig a GET, ahhoz hogy POST-tal menj&uuml;nk, &iacute;gy haszn&aacute;ld: {search search_method=&quot;post&quot;} ';
$lang['export_to_csv'] = 'Export&aacute;l&aacute;s CSV form&aacute;tumba';
$lang['prompt_savephrases'] = 'Kereső szavak helyett kereső kifejez&eacute;sek k&ouml;vet&eacute;se';
$lang['word'] = 'Sz&oacute;';
$lang['count'] = 'Előfordul&aacute;sok sz&aacute;ma';
$lang['confirm_clearstats'] = 'Biztos t&ouml;r&ouml;lsz minden keres&eacute;si statisztik&aacute;t?';
$lang['clear'] = 'T&ouml;rl&eacute;s';
$lang['statistics'] = 'Statisztika';
$lang['param_action'] = 'Add meg a modul műk&ouml;d&eacute;si m&oacute;dj&aacute;t.  A haszn&aacute;lhat&oacute; &eacute;rt&eacute;kek a &#039;default&#039;, &eacute;s a  &#039;keywords&#039;.  A &#039;keywords&#039; haszn&aacute;lhat&oacute; arra, hogy gener&aacute;ljunk egy vesszővel tagolt list&aacute;t, amit a meta tag-ben lehet haszn&aacute;lni.';
$lang['param_count'] = 'A &#039;keywords&#039;-szel haszn&aacute;lva ez a param&eacute;ter korl&aacute;tozza a kimenetre gener&aacute;lt szavak sz&aacute;m&aacute;t';
$lang['param_pageid'] = 'A &#039;keywords&#039;-szel haszn&aacute;lva ez a param&eacute;ter adja meg azt az oldal azonos&iacute;t&oacute;t, ahol a tal&aacute;latok fognak megjelenni';
$lang['param_inline'] = 'Ha az &eacute;rt&eacute;k &#039;igaz&#039;, akkor a kereső form kimenete fel&uuml;l&iacute;rja az eredeti tartalom &#039;search&#039; taggal jel&ouml;lt r&eacute;sz&eacute;t az eredeti tartalom blokkban. Ezt a param&eacute;tert akkor &eacute;rdemes haszn&aacute;lni, ha t&ouml;bb tartalmi blokkod van &eacute;s nem akarod, hogy az alap&eacute;rtelmezett blokk &iacute;r&oacute;djon fel&uuml;l.';
$lang['param_passthru'] = 'N&eacute;vvel ell&aacute;tott param&eacute;terek &aacute;tad&aacute;sa a megadott moduloknak. Az egyes param&eacute;terek form&aacute;tuma: &quot;passtru_MODULENAME_PARAMNAME=&#039;value&#039;&quot; i.e.: passthru_News_detailpage=&#039;newsdetails&#039;&quot;';
$lang['param_modules'] = 'A keres&eacute;si eredm&eacute;nyek szűk&iacute;t&eacute;se a megadott modulokra (veszőkkel elv&aacute;lasztva a k&eacute;rd&eacute;ses modul nevek).';
$lang['searchsubmit'] = 'Elk&uuml;ld';
$lang['search'] = 'Keres&eacute;s';
$lang['param_submit'] = 'A kereső gombra &iacute;rand&oacute; sz&ouml;veg';
...
$lang['prompt_alpharesults'] = 'Eredm&eacute;nyek alfabetikus rendez&eacute;se (a s&uacute;lyozott rendez&eacute;s helyett)';
...
$lang['reindexcomplete'] = 'A teljes &uacute;jraindexel&eacute;s elk&eacute;sz&uuml;lt!';
