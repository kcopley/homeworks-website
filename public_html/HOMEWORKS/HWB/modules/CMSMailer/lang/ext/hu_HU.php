<?php
$lang['info_cmsmailer'] = 'Ezt a modult sz&aacute;mtalan m&aacute;sik felhaszn&aacute;lja e-mail k&uuml;ld&eacute;s c&eacute;lj&aacute;b&oacute;l. Pontos be&aacute;ll&iacute;t&aacute;sa sz&uuml;ks&eacute;ges a host futtat&oacute;k&ouml;rnyezethez. A hosting szolg&aacute;ltat&oacute;t&oacute;l kapott inform&aacute;ci&oacute;k alapj&aacute;n &eacute;rdemes pr&oacute;b&aacute;lkoznod. Ha m&eacute;g &iacute;gy sem megy a teszt &uuml;zenet kik&uuml;ld&eacute;se, akkor k&eacute;rd a hosting szolg&aacute;ltat&oacute; tov&aacute;bbi seg&iacute;ts&eacute;g&eacute;t.

';
$lang['charset'] = 'Karakter kioszt&aacute;s';
$lang['sendtestmailconfirm'] = 'Egy teszt&uuml;zenetet fogunk k&uuml;ldeni a megadott c&iacute;mre. Ha a k&uuml;ld&eacute;s sikeres, akkor visszat&eacute;r&uuml;nk erre az oldalra. Folytatod?';
$lang['settingsconfirm'] = '&Iacute;rjuk ezeket az &eacute;rt&eacute;keket a CMSMailer be&aacute;ll&iacute;t&aacute;sokhoz?';
$lang['testsubject'] = 'CMSMailer Teszt &Uuml;zenet';
$lang['testbody'] = 'Ezt az &uuml;zenetet az&eacute;rt kaptad, hogy ellenőrizhess&uuml;k a CMSMailer modul be&aacute;ll&iacute;t&aacute;sainek helyess&eacute;g&eacute;t.

Ha megkaptad, akkor minden helyesen van be&aacute;ll&iacute;tva &eacute;s &ouml;r&uuml;l&uuml;nk.';
$lang['error_notestaddress'] = 'Hiba: Nincs megadva tesztc&iacute;m';
$lang['prompt_testaddress'] = 'Teszt Email C&iacute;m';
$lang['sendtest'] = 'Teszt &Uuml;zenet K&uuml;ld&eacute;se';
$lang['password'] = 'Jelsz&oacute;';
$lang['username'] = 'Felhaszn&aacute;l&oacute; n&eacute;v';
$lang['smtpauth'] = 'SMTP Hiteles&iacute;t&eacute;s';
$lang['mailer'] = '&Uuml;zenetk&uuml;ld&eacute;si met&oacute;dus';
$lang['host'] = 'SMTP host neve<br/><i>(vagy IP c&iacute;me)</i>';
$lang['port'] = 'SMTP Port sz&aacute;ma';
$lang['from'] = 'Felad&oacute; c&iacute;me';
$lang['fromuser'] = 'Felad&oacute; felhaszn&aacute;l&oacute;i neve';
$lang['sendmail'] = 'Sendmail &uacute;tvonal';
$lang['timeout'] = 'SMTP időkorl&aacute;t';
$lang['submit'] = 'Elk&uuml;ld';
$lang['cancel'] = 'M&eacute;gsem';
$lang['info_mailer'] = 'Haszn&aacute;lnd&oacute; email met&oacute;dus (sendmail, smtp, mail).  &Aacute;ltal&aacute;ban az smtp a legmegb&iacute;zhat&oacute;bb.';
$lang['info_host'] = 'SMTP host neve (csak az smtp met&oacute;dus eset&eacute;n &eacute;rv&eacute;nyes)';
$lang['info_port'] = 'SMTP port sz&aacute;ma (&aacute;tal&aacute;ban 25) (csak az smtp met&oacute;dus eset&eacute;n &eacute;rv&eacute;nyes)';
$lang['info_from'] = 'A felad&oacute; c&iacute;me az &ouml;sszes kimenő mail-en';
$lang['info_fromuser'] = 'A felad&oacute; term&eacute;szetes neve az &ouml;sszes kimenő mail-en';
$lang['info_sendmail'] = 'A sendmail bin&aacute;ris teljes &uacute;tvonala (csak a sendmail met&oacute;dus eset&eacute;n &eacute;rv&eacute;nyes)';
$lang['info_timeout'] = 'Azon m&aacute;sodpercek sz&aacute;ma egy SMTP kommunik&aacute;ci&oacute;ban, amit m&eacute;g elfogadunk &eacute;rv&eacute;nyesnek (csak az smtp met&oacute;dus eset&eacute;n &eacute;rv&eacute;nyes)';
$lang['info_smtpauth'] = 'Megk&ouml;veteli az SMTP host a hiteles&iacute;t&eacute;st? (csak az smtp met&oacute;dus eset&eacute;n &eacute;rv&eacute;nyes)';
$lang['info_username'] = 'SMTP hiteles&iacute;t&eacute;shez haszn&aacute;lt felhaszn&aacute;l&oacute; n&eacute;v (csak az smtp met&oacute;dus eset&eacute;n &eacute;rv&eacute;nyes, amikor a hiteles&iacute;t&eacute;s is ki van v&aacute;lasztva)';
$lang['info_password'] = 'SMTP hiteles&iacute;t&eacute;shez haszn&aacute;lt jelsz&oacute; (csak az smtp met&oacute;dus eset&eacute;n &eacute;rv&eacute;nyes, amikor a hiteles&iacute;t&eacute;s is ki van v&aacute;lasztva)';
