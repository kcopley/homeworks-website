...
Αυτή η ενότητα χρησιμοποιείται από πολυάριθμες άλλες ενότητες
για να διευκολύνει την αποστολή των ηλεκτρονικών ταχυδρομείων.
Πρέπει να διαμορφωθεί κατάλληλα στις απαιτήσεις του πάροχου/διακομιστή σας.
Παρακαλώ χρησιμοποιήστε τις πληροφορίες που παρέχονται από τον
πάροχο/διακομιστή σας για να σεταρετε αυτές τις ρυθμησεις. Εάν ακόμα δεν
μπορείτε  να λάβετε το απεσταλμενο δοκιμαστικό μήνυμα αλληλογραφίας , 
μπορεί να πρέπει να έρθετε σε επαφή με τον πάροχο του διακομιστή σας για  βοήθεια.


';
$lang['charset'] = 'Χαρακτήρες';
$lang['sendtestmailconfirm'] = 'Θα αποσταλεί ενα δοκιμαστικό μήνυμα στην προκαθορισμένη διεύθυνση. Αν η διαδικασία αποστολής είναι επιτυχής, Θα επιστρέψετε σε αυτήν την σελίδα.  Θέλετε να συνεχίσετε?';
$lang['settingsconfirm'] = 'Να εγγραφούν οι τρέχουσες ρυθμίσεις για το CMSMailer?';
$lang['testsubject'] = 'Δοκιμαστικό μήνυμα CMSMailer';
$lang['testbody'] = 'Αυτό το μήνυμα έχει στόχο την επαλήθευση της εγκυρότητας των ρυθμίσεων του αρθρώματος CMSMailer.
Αν το παραλάβετε, όλα λειτουργούν σωστά.';
$lang['error_notestaddress'] = 'Σφάλμα: Δεν ορίστηκε διεύθυνση για την δοκιμή';
$lang['prompt_testaddress'] = 'Email Διεύθυνση για την δοκιμή';
$lang['sendtest'] = 'Αποστολή δοκιμαστικού μηνύματος';
$lang['password'] = 'Κωδικός πρόσβασης';
$lang['username'] = 'Όνομα χρήστη';
$lang['smtpauth'] = 'Αυθεντικοποίηση SMTP';
$lang['mailer'] = 'Μέθοδος αποστολής e-mail';
$lang['host'] = 'Ονομα διακομιστή SMTP<br/><i>(ή διεύθυνση IP)</i>';
$lang['port'] = 'Θύρα διακομιστή SMTP';
$lang['from'] = 'Διεύθυνση Από:';
$lang['fromuser'] = 'Όνομα χρήστη Από:';
$lang['sendmail'] = 'Τοποθεσία Sendmail';
$lang['timeout'] = 'Χρονικό όριο SMTP';
$lang['submit'] = 'Αποστολή';
$lang['cancel'] = 'Άκυρο';
$lang['info_mailer'] = 'Χρήση μεθόδου αποστολής (sendmail, smtp, mail).  Συνήθως το smtp είναι πιο αξιόπιστο.';
$lang['info_host'] = 'Ονομα διακομιστή SMTP (στην περίπτωση επιλογής μεθόδου smtp)';
$lang['info_port'] = 'Θύρα SMTP (συνήθως 25) (στην περίπτωση επιλογής μεθόδου smtp)';
$lang['info_from'] = 'Η διεύθυνση που θα χρησιμοποιείται σαν αποστολέας σε όλα τα e-mails';
$lang['info_fromuser'] = 'Το όνομα που θα εμφανίζεται σαν αποστολέας σε όλα τα e-mails';
$lang['info_sendmail'] = 'Η διαδρομή δίσκου πρός το εκτελέσιμο αρχείο του sendmail (στην περίπτωση επιλογής μεθόδου sendmail)';
$lang['info_timeout'] = 'Αριθμός δευτερολέπτων στην  επικοινωνία SMTP conversation πρίν εμφανιστεί σφάλμα (στην περίπτωση επιλογής μεθόδου smtp)';
$lang['info_smtpauth'] = 'Ο διακομιστής smtp απαιτεί αυθεντικοποίηση (στην περίπτωση επιλογής μεθόδου smtp)';
$lang['info_username'] = 'Όνομα χρήστη για την αυθεντικοποίηση SMTP (στην περίπτωση επιλογής μεθόδου smtp, και όταν έχει επιλεγεί αυθεντικοποίηση στο smtp)';
$lang['info_password'] = 'Κωδικός πρόσβασης για την αυθεντικοποίηση SMTP (στην περίπτωση επιλογής μεθόδου smtp, και όταν έχει επιλεγεί αυθεντικοποίηση στο smtp)';
$lang['friendlyname'] = 'Άρθρωμα CMSMailer';
$lang['postinstall'] = 'Το άρθρωμα CMSMailer εγκαταστάθηκε επιτυχώς';
$lang['postuninstall'] = 'Το άρθρωμα CMSMailer αποεγκαταστάθηκε...κρίμα';
$lang['uninstalled'] = 'Το άρθρωμα  απεγκαταστάθηκε.';
$lang['installed'] = 'Το άρθρωμα έχει εγκατεστημένη την έκδοση %s.';
...
$lang['title_mod_admin'] = 'Περιοχή διαχείρισης αρθρώματος';
$lang['title_admin_panel'] = 'Άρθρωμα "CMSMailer"';
$lang['moddescription'] = 'Αυτό το άρθρωμα είναι ένας PHPMailer, έχει ένα ισοδύναμο API (function for function) και ένα απλό περιβάλλον με μερικές προεπιλεγμένες ρυθμίσεις.';
$lang['welcome_text'] = '<p>Καλωσήλθατε στην περιοχή διαχείρισης του αρθρώματος CMSMailer';
$lang['changelog'] = '<ul>
...
<p>Το άρθρωμα δεν είναι λειτουργικό αυτόνομα.  Έχει σχεδιαστεί να λειτουργεί μέσα απο άλλα αρθρώματα για την παροχή δυνατοτήτων email. </p>
<h3>Οδηγίες χρήσης (ακολουθεί κείμενο στην αγγλική)</h3>
...
';
$lang['utmz'] = '156861353.1229948860.4.3.utmcsr=google|utmccn=(organic)|utmcmd=organic|utmctr=cmsms language files';
$lang['utma'] = '156861353.1266373964.1229795251.1231957295.1232404887.15';
$lang['utmc'] = '156861353';
$lang['utmb'] = '156861353';
?>