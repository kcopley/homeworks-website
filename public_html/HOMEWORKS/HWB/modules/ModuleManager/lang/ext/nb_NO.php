<?php
$lang['error_searchterm'] = 'Vennligst oppgi noe som er gyldig &aring; s&oslash;ke etter';
$lang['search_noresults'] = 'S&oslash;k lyktes men ingen resultater matchet uttrykket det ble s&oslash;kt etter';
$lang['advancedsearch_help'] = 'Angi ord som skal inkluderes eller ekskluderes fra s&oslash;ket ved hjelp av en + eller -, omslutt eksakte setninger med sitattegn. i.e:   +r&oslash;d -eple +&quot;tekst&quot;';
$lang['search_results'] = 'S&oslash;keresultater';
$lang['prompt_advancedsearch'] = 'Avansert s&oslash;k';
$lang['search_input'] = 'S&oslash;k etter';
$lang['searchterm'] = 'S&oslash;keord';
$lang['search'] = 'S&oslash;k';
$lang['available_updates'] = 'Moduler tilgjengelig for oppdatering, F&oslash;r du oppgraderer, vennligst les utgivelsenotatene i Forge og opprett en sikkerhetskopi av nettstedet.';
...
$lang['notice_depends'] = '%s krever f&oslash;lgende handling. Klikk p&aring;  &quot;Installer&quot; for &aring; fortsette.';
$lang['install_submit'] = 'Installer';
$lang['depend_upgrade'] = 'Modul %s trenger &aring; oppgraderes til versjon %s.';
$lang['depend_install'] = 'Modul %s (versjon %s eller senere) m&aring; v&aelig;re installert';
$lang['depend_activate'] = 'Modul %s trenger &aring; aktiveres.';
$lang['action_activated'] = 'Modul %s har blitt aktivert.';
$lang['action_installed'] = 'Modul %s har blitt installert med f&oslash;lgende melding(er): %s';
$lang['action_upgraded'] = 'Modul %s har blitt oppgradert';
$lang['title_installation_complete'] = 'Installasjonsprosessen fullf&oslash;rt!';
$lang['install_with_deps'] = 'Evaluere alle avhengigheter og installer';
$lang['msg_nodependencies'] = 'Denne filen har ikke oppf&oslash;rt noen avhengigheter';
$lang['error_upgrade'] = 'Oppgradering av modul %s feilet!';
$lang['error_skipping'] = 'Hopper over installering/oppgradering av %s p&aring; grunn av feil med &aring; sette opp avhengighetene. Vennligst se meldingen overfor, og fors&oslash;k igjen.';
$lang['dependstxt'] = 'Avhengigheter';
$lang['use_at_your_own_risk'] = 'Bruk p&aring; egen risiko';
$lang['compatibility_disclaimer'] = 'Modulene som vises her er bidratt med av b&aring;de CMS utviklerne og tredjepartsutviklere. Vi gir ingen garanti for at modulene som er tilgjengelige her fungerer, testet, eller kompatible med ditt system. Du oppfordres til &aring; lese informasjonen du finner i hjelp og i &quot;Om&quot; linkene for hver modul f&oslash;r du fors&oslash;ker &aring; installere.';
$lang['notice'] = 'Merk';
$lang['general_notice'] = 'Versjonene som vises her representerer de siste XML filene som er lastet opp til ditt valgte modulbibliotek (vanligvis er dette CMS %s).  De b&oslash;r (men med unntak) representere de siste tilgjengelige versjonene.';
...
$lang['error_connectnomodules'] = 'Selv om tilkobling var vellykket til det spesifiserte modullageret, s&aring; ser det ut til at dette lageret enn&aring; ikke deler noen moduler';
...
$lang['time_warning'] = 'Om en installasjonsliste har mere enn en eller to moduler, s&aring; v&aelig;r oppmerksom p&aring; at installasjonen kan ta noen minutter. Vennligst v&aelig;r t&aring;lmodig!';
$lang['helptxt'] = 'Hjelp';
$lang['abouttxt'] = 'Om';
...
$lang['postuninstall'] = 'Modulbehandler har blitt avinstallert. Brukere vil ikke lengre ha mulighet til &aring; installere moduler fra fjern-bibliotek. Men, lokalinstallasjoner er fortsatt mulig.';
$lang['really_uninstall'] = 'Er du sikker p&aring; at du vil avinstallere? Du vil miste en masse fin funksjonalitet.';
...
$lang['back_to_module_manager'] = '&laquo; Tilbake til Modulebehandleren';
$lang['error'] = 'Feil!';
