<?php
$lang['set_cachable'] = 'Dit sjabloon kan gebufferd worden.';
$lang['help_nocache'] = 'Stel het bufferen van bestanden uit als u deze menu aanroep gebruikt. Deze parameter zal, als deze een positieve waarde heeft de instellingen van de Content en de Menu sjabloon negeren.';
$lang['cachable'] = 'Te bufferen';
$lang['help_childrenof'] = 'Deze optie laat alleen onderliggende pagina&#039;s zijn van de gespecificeerde pagina id of alias. Bijv.: <code>{menu childrenof=$page_alias}</code> zal alleen de onderliggende pagina&#039;s tonen van de huidige pagina.';
$lang['usage'] = 'Gebruik';
...
$lang['description'] = 'Beheer menu sjablonen om menu&#039;s in alle denkbare vormen te tonen.';
...
$lang['help_includeprefix'] = 'Bevat die items waarvan de pagina alias overeen komt met een van de opgegeven (komma gescheiden) prefixen. Deze parameter mag niet gecombineerd worden met de exclude prefix parameter.';
$lang['help_excludeprefix'] = 'Sluit alle items uit (en hun subitems) waarvan de pagina alias overeen komt met een van de opgegeven (komma gescheiden) prefixen. Deze parameter mag niet gecombineerd worden met de include prefix parameter.';
$lang['help_collapse'] = 'Zet aan (zet op 1) om de menu items die niet gerelateerd zijn aan de huidige pagina, onzichtbaar te laten maken .';
...
$lang['help_start_element'] = 'Start een menu weergave op elk gegeven start_element en laat alleen dat element zien en de onderliggende elementen.  Gebruikt een hi&euml;rarchie positie (b.v. 5.1.2).';
...
$lang['importtemplate'] = 'Importeer dit menusjabloon in de database om het te kunnen wijzigen (Naam zonder extentie invoeren)';
...
$lang['utma'] = '156861353.1335698708.1284586217.1289761687.1289763652.367';
$lang['utmz'] = '156861353.1289407802.324.41.utmcsr=forum.cmsmadesimple.org|utmccn=(referral)|utmcmd=referral|utmcct=/index.php';
$lang['qca'] = 'P0-1551306179-1284586216711';
$lang['utmc'] = '156861353';
$lang['utmb'] = '156861353.1.10.1289763652';
?>