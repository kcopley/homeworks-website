<?php
$lang['help_loadprops'] = 'Utilitza aquest par&agrave;metre quan usis les propietats avan&ccedil;ades en la teva plantilla de gestor de men&uacute;s. Aquest par&agrave;metre for&ccedil;ar&agrave; la c&agrave;rrega de totes les propietats de contingut per cada node (com ara l&#039;extra1, image, thumbnail, etc.) and incrementar&agrave; dram&agrave;ticament el nombre de consultes necess&agrave;ries per construir el men&uacute;, i incrementar&agrave; les necessitats de mem&ograve;ria, per&ograve; permetr&agrave; men&uacute;s molt m&eacute;s avan&ccedil;ats.';
$lang['readonly'] = 'nom&eacute;s lectura';
$lang['error_templatename'] = 'You cannot specify a template name ending with .tpl';
$lang['this_is_default'] = 'plantilla de men&uacute; per defecte';
$lang['set_as_default'] = 'Fixa com a plantilla de men&uacute; per defecte';
