<?php
$lang['help_nocache'] = 'Vypn&uacute;ť ke&scaron;ovanie tohto menu. ';
$lang['cachable'] = 'ke&scaron;ovateľn&eacute;';
$lang['help_childrenof'] = 'Nastavenie, ktor&eacute; zobraz&iacute; iba podraden&eacute; prvky položky (m&ocirc;že byť id str&aacute;nky, alias).  pr&iacute;klad: <code>{menu childrenof=$page_alias}</code>';
$lang['usage'] = 'Použitie';
