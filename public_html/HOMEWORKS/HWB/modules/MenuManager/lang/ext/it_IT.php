<?php
$lang['set_cachable'] = 'Fissa questo template come cachable';
$lang['help_nocache'] = 'Disabilita il caching di questa chiamata al menu. Questo parametro, se fissato a valori positivi sovrascrive qualsiasi impostazione nell&#039;oggetto content e menu template.';
$lang['cachable'] = 'Cachable';
$lang['help_childrenof'] = 'Questa opzione visualizzer&agrave; il menu solo con i discendenti della pagina ID o alias. p.e: <code>{menu childrenof=$page_alias}</code> visualizzer&agrave; solo i figli della pagina corrente.';
$lang['usage'] = 'Uso';
