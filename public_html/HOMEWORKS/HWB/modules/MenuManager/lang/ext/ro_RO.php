<?php
$lang['help_childrenof'] = 'Aceasta optiune face ca meniul sa afiseze numai obiecte care sunt descendenti ai id-ului sau aliasului de pagina selectat.  Ex: <code>{menu childrenof=$page_alias}</code> va afisa numai descendentii paginii curente.';
$lang['usage'] = 'Folosire';
