...
$lang['graphics_settings'] = 'Grafische Einstellungen';
...
<p>Dieses Modul stellt eine API, wiederverwendbare Formulare und Smarty-Tags zur Verwendung in anderen Modulen bereit. Das heisst, es ist ausschlie&szlig;lich eine Basis-Klasse und Werkzeug-Klasse f&uuml;r andere Module. Wenn Sie kein Programmierer sind, sollten Sie kaum mit dem Modul zu tun haben (au&szlig;er vielleicht ein paar Einstellungen vornehmen).</p>
<h3 style=&quot;color: #f00;&quot;>Hinweise</h3>
<p>Einige Module verwenden f&uuml;r die Verwaltung von Templates Formulare, die vom CGExtensions-Modul bereit gestellt werden. In diesem Fall wird das CGExtensions-Modul angezeigt. Wenn Sie dann in diesen Formularen auf &bdquo;Absenden&ldquo; oder &bdquo;Abbrechen&ldquo; klicken, kehren Sie wieder zu dem urspr&uuml;nglichen Modul zur&uuml;ck.</p>
<h3>Wie wird es eingesetzt?</h3>
<p>OK, Sie m&ouml;chten ein eigenes Modul programmieren (ich emfehle Ihnen, mit dem Skeleton-Modul zu beginnen). Wenn Sie ein Formular-Objekt aus dieser Bibliothek ben&ouml;tigen, m&uuml;ssen Sie Ihr Modul nur von FormObjects abh&auml;ngig machen und dann ein Objekt des entsprechenden Typs instanziieren. F&uuml;r weitere Informationen sehen Sie sich bitte den Code im Verzeichnis FormObjects an.</p>
...
<ul>
<li>F&uuml;r die letzte Version dieses Moduls, FAQs, dem Versand eines Fehlerreports oder dem Kauf kommerziellen Support besuchen Sie bitte die Projektseite unter <a href="http://dev.cmsmadesimple.org">dev.cmsmadesimple.org</a>.</li>
