...
class nusoap_base {
	...
	*/
	...
	function nusoap_base() {
	  ...
	  $this->debugLevel = $GLOBALS['nusoap_debug_level'];
	...
	*/
	...
	function getGlobalDebugLevel() {
	  ...
	  return $GLOBALS['nusoap_debug_level'];
	...
	*/
	...
	function setGlobalDebugLevel($level) {
	  ...
	  $GLOBALS['nusoap_debug_level'] = $level;
    ...
    */
    ...
    function webDescription(){
...

		{
		  ...
		  $PHP_SELF = $PHP_SELF . "?module=". $_GET['module'];
		...
		<div class=content>
			...
			<div class=nav>
				...
				<p>View the <a href="'.$PHP_SELF . $delimiter . 'wsdl">WSDL</a> for the service.
