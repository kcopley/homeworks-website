<?php
$lang['info_detail_returnid'] = 'Denne innstillingen brukes til &aring; fastsl&aring; en side (og derfor en mal) &aring; bruke til &aring; vise detaljsider. Individuelle Nyhetsdetalj nettadresser vil ikke fungere hvis denne parameteren ikke er satt til en gyldig side. I tillegg, hvis denne innstillingen er satt, og ingen detaljside-parameter er gitt p&aring; nyhetstaggen, s&aring; vil denne verdien bli brukt for detaljlenker';
$lang['title_detail_returnid'] = 'Standardside &aring; benytte for detaljvisninger';
...
$lang['url'] = 'URL ';
$lang['expired_searchable'] = 'Utl&oslash;pte artikler f&aring;r vises i s&oslash;keresultat';
$lang['helpshowall'] = 'Vis alle artikler, uten &aring; ta hensyn til utl&oslash;psdato';
...
$lang['title_browsecat_template'] = 'S&oslash;k-Kategorimal redigerer';
$lang['title_browsecat_sysdefault'] = 'Standard S&oslash;k-Kategorimal';
$lang['browsecattemplate'] = 'S&oslash;k-Kategorimaler';
$lang['error_filesize'] = 'En opplastet fil oversteg maksimalt tillatt st&oslash;rrelse';
$lang['post_date_desc'] = 'Publiseringsdato synkende';
$lang['post_date_asc'] = 'Publiseringsdato stigende';
$lang['expiry_date_desc'] = 'Utl&oslash;per dato synkende';
$lang['expiry_date_asc'] = 'Utl&oslash;per dato stigende';
...
$lang['allowed_upload_types'] = 'Tillat kun filer med disse filendelsene &aring; bli lastet opp';
...
$lang['type'] = 'Type ';
$lang['info_maxlength'] = 'Maksimum lengde p&aring;virker kun tekst innskrivingsfelter.';
...
$lang['email_subject'] = 'Emne for den utg&aring;ende eposten';
$lang['email_template'] = 'Formatet p&aring; eposten';
$lang['formsubmit_emailaddress'] = 'Epostadresse &aring; motta meldinger om nyhetposteringer';
$lang['extra'] = 'Ekstra';
...
$lang['info_sysdefault2'] = '<strong>Merk:</strong> Denne fanen inneholder tekstomr&aring;der som tillater deg &aring; redigere de malene som vises n&aring;r du oppretter et &#039;nytt&#039; sammendrag, detalj, eller skjema mal. &Aring; endre innhold i denne fanen og klikke &#039;utf&oslash;r&#039; vil <strong>ikke ha effekt p&aring; n&aring;v&aelig;rende visninger</strong>.';
$lang['info_sysdefault'] = '<em>(malen som er benyttet som standard n&aring;r en ny mal velges)</em>';
$lang['template'] = 'Mal';
$lang['prompt_name'] = 'Navn';
$lang['prompt_default'] = 'Standard';
$lang['prompt_newtemplate'] = 'Opprett ny mal';
$lang['help_pagelimit'] = 'Maksimalt antall artikler &aring; vise (pr side). Om denne parameter ikke settes vil alle passende artikler vises. Om satt, og det er fler artikler tilgjengelig enn spesifisert i parameteren, vil tekst og lenker vises for &aring; tillate &aring; rulle gjennom resultatene';
...
$lang['endrequiresstart'] = 'Om sluttdato er satt s&aring; kreves ogs&aring; en startdato.';
$lang['entries'] = '%s oppf&oslash;ringer';
$lang['status'] = 'Status ';
$lang['expiry'] = 'Utl&oslash;per';
$lang['filter'] = 'Filtrer';
$lang['more'] = 'Mer';
...
$lang['needpermission'] = 'Du trenger &#039;%s&#039; rettighet for &aring; utf&oslash;re denne handlingen.';
...
$lang['startoffset'] = 'Start visning p&aring; nde artikkel';
$lang['startrequiresend'] = 'Dersom du har en startdato m&aring; du ogs&aring; ha en sluttdato';
...
$lang['helpdetailtemplate'] = 'Bruk en separat database mal for visning av artikkel detaljene. Denne malen m&aring; eksistere og m&aring; v&aelig;re synlig i Detalj malfanen i Nyheter administrasjonen, men den trenger ikke &aring; v&aelig;re standard. Om denne parameter ikke er satt, vil gjeldende standardmal benyttes.';
$lang['helpsortby'] = 'Felt &aring; sortere etter.  Alternativene er &#039;news_date&#039;, &#039;summary&#039;, &#039;news_data&#039;, &#039;news_category&#039;, &#039;news_title&#039;, &#039;news_extra&#039;, &#039;end_time&#039;, &#039;start_time&#039;, &#039;random&#039;.  Standardsetting er &#039;news_date&#039;. Om tilfeldig(random) er valgt vil sortasc parameteren bli ignorert.';
$lang['helpsortasc'] = 'Sorter nyhetselementer i stigende rekkef&oslash;lge i stedet for synkende.';
