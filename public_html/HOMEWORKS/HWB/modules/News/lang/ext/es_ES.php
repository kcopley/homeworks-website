<?php
$lang['expired_searchable'] = 'Articulos expirados pueden aparecer en resultados de busquedas';
$lang['helpshowall'] = 'Mostrar todos los articulos, sin importar la fecha en que finalizan';
...
$lang['notify_n_draft_items'] = 'Tienes <a href="moduleinterface.php?module=News">%d art&iacute;culos de noticias</a> que no han sido publicados';
...
$lang['msg_contenttype_removed'] = 'El tipo de contenido de noticias se ha quitado.  Por favor ubique los tags {news} con los par&aacute;metros apropiados en su plantilla de p&aacute;gina o en su contenido de p&aacute;gina para reemplazar &eacute;sta funcionalidad.';
...
$lang['allowed_upload_types'] = 'Permitir que se suban s&oacute;lo archivos con &eacute;stas extensiones';
...
$lang['subject_newnews'] = 'Se ha ingresado un nuevo art&iacute;culo de Noticias';
$lang['email_subject'] = 'El Asunto del email saliente';
$lang['email_template'] = 'El formato del mensaje email';
$lang['formsubmit_emailaddress'] = 'Direcci&oacute;n email para recibir notificaciones de nuevos env&iacute;os';
$lang['extra'] = 'Extra ';
$lang['uploadscategory'] = 'Categor&iacute;a de Cargas';
$lang['title_available_templates'] = 'Plantillas Disponibles';
$lang['resettodefault'] = 'Resetear a Valores Iniciales';
...
$lang['title_form_sysdefault'] = 'Formulario de Plantilla por Defecto';
$lang['title_summary_sysdefault'] = 'Plantilla de Resumen por Defecto';
$lang['title_detail_sysdefault'] = 'Plantilla de Detalles por Defecto';
$lang['info_sysdefault2'] = '<strong>Nota:</strong> Esta solapa contiene &aacute;reas de texto que van a permitir a usted editar a un grupo de plantillas que son mostradas cuando crea una \&#039;nueva\&#039; plantilla de resumen, detalles, o formulario.  Cambiando el contenido en &eacute;sta solapa, y haciendo click en \&#039;Enviar\&#039; <strong>no va a producir ning&uacute;n efecto en las actuales publicaciones</strong>.';
$lang['info_sysdefault'] = '<em>(el contenido usado por defecto cuando se crea una nueva plantilla)';
...
$lang['categoryadded'] = 'Se a&ntilde;adi&oacute; la categor&iacute;a correctamente.';
$lang['categoryupdated'] = 'Se actualiz&oacute; la categor&iacute;a correctamente.';
$lang['categorydeleted'] = 'Se borr&oacute; la categor&iacute;a correctamente.';
...
$lang['helpmoretext'] = 'Texto a mostrar al final de un item noticia si esta supera la longitud del sumario.  Por defecto es &quot;M&aacute;s...&quot;';
...
$lang['helpformtemplate'] = 'Usar una plantilla de la base de datos para mostrar el formulario de presentaci&oacute;n del art&iacute;culo. Esta plantilla debe existir y estar visible en la solapa de formularios de plantillas de la administraci&oacute;n de Noticias, sin embargo no tiene porqu&eacute; ser la plantilla por defecto.  Si este par&aacute;metro no se especifica, entonces se usar&aacute; a la actual plantilla marcada como por defecto.';
...
$lang['helpsortby'] = 'Campo por el que ordenar.  Las opciones son: &quot;news_date&quot;, &quot;summary&quot;, &quot;news_data&quot;, &quot;news_category&quot;, &quot;news_title&quot;, &quot;random&quot;.  Por  defecto est&aacute; puesto &quot;news_date&quot;. Si se especifica &quot;random&quot;, el par&aacute;metro sortasc es ignorado.';
