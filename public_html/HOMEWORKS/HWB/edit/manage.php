...
class Example1 extends Common
{
	...
	function initiateEditor()
	{
		...
		$tableColumns['product_name'] = array('display_text' => 'Product Name', 'perms' => 'EVCTAXQSHO');
		$tableColumns['details'] = array('display_text' => 'Details', 'perms' => 'EVCTAXQSHO');
		$tableColumns['price'] = array('display_text' => 'Price', 'perms' => 'EVCTAXQSHO');
		$tableColumns['cost'] = array('display_text' => 'Cost', 'perms' => 'EVCTAXQSHO');
		$tableColumns['msrp'] = array('display_text' => 'MRRP', 'perms' => 'EVCTAXQSHO');
		$tableColumns['sku'] = array('display_text' => 'ISBN', 'perms' => 'EVCTAXQSHO');
		$tableColumns['alias'] = array('display_text' => 'Alt ISBN', 'perms' => 'EVCTAXQSHO');
		$tableColumns['vendor'] = array('display_text' => 'Vendor', 'perms' => 'EVCTAXQSHO');
		$tableColumns['department'] = array('display_text' => 'Department', 'perms' => 'EVCTAXQSHO');
		$tableColumns['category'] = array('display_text' => 'Category', 'perms' => 'EVCTAXQSHO');
		$tableColumns['sub_category'] = array('display_text' => 'Sub Category', 'perms' => 'EVCTAXQSHO');
		$tableColumns['quantity'] = array('display_text' => 'Quantity', 'perms' => 'EVCTAXQSHO');
		$tableColumns['active'] = array('display_text' => 'Acive', 'perms' => 'EVCTAXQSHO', 'select_array' => array('Active' => 'Active', 'Inactive' => 'Inactive'), 'default' => 'Active'); 
		
		 
		$tableName = 'cms_module_products';
		$primaryCol = 'id';
		...
		$this->Editor->setConfig('orderByColumn','product_name');
		$this->Editor->setConfig('addRowTitle','Add Product');
		$this->Editor->setConfig('editRowTitle','Edit Product');
		$this->Editor->setConfig('iconTitle','Edit Product');
	}
