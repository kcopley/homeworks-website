...
$lang['admin']['invalid_url'] = 'Адрес страницы указан неверно.  Он может содержать только буквенно-цифровые символы, или - или /. Также возможно, что указанный URL уже используется.';
...
$lang['admin']['utmz'] = '156861353.1291999294.105.50.utmcsr=forum.cmsmadesimple.org|utmccn=(referral)|utmcmd=referral|utmcct=/index.php/board,27.0.html';
