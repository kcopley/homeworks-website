...
$lang['admin']['help_function_browser_lang'] = '<h3>Que fait cette Balise ?</h3>
  <p>Cette balise d&eacute;tecte la langue, utilis&eacute;e et d&eacute;finie par l&#039;utilisateur du navigateur, et les r&eacute;f&eacute;rences crois&eacute;es si une liste des langues d&eacute;termine une valeur de la langue de session.</p>
<h3>Comment l&#039;utiliser ?</h3>
<p>Ins&eacute;rer la balise dans votre gabarit :  <em>(il peut &ecirc;tre  au-dessus la section < head > si vous voulez)</em> et lui indiquer le nom de la langue par d&eacute;faut, et les langues accept&eacute;es (seul deux caract&egrave;re de noms de langue sont accept&eacute;s), puis utiliser le r&eacute;sultat. Exemple :</p>
...
<ul>
<li><strong>(requis) accepted</strong> - Une virgule comme s&eacute;parateur de liste pour les deux caract&egrave;res de noms de langue accept&eacute;e.</li>
 <li><em>(option)</em> default - La langue par d&eacute;faut, si aucune langue accept&eacute;e n&#039;a &eacute;t&eacute; prise en charge par le navigateur. &quot;en&quot; est utilis&eacute;e si aucune valeur n&#039;est sp&eacute;cifi&eacute;e</li>
 <li><em>(option)</em> assign - Le nom de la variable Smarty pour affecter les r&eacute;sultats. Si non sp&eacute;cifi&eacute; les r&eacute;sultats de cette fonction sont retourn&eacute;s.</li>
</ul>';
$lang['admin']['info_target'] = 'Cette option peut utilis&eacute; par le gestionnaire de menu (Module Manager) pour indiquer quand et comment de nouvelles fen&ecirc;tres doivent &ecirc;tre ouvertes. Certains gabarits du gestionnaire de menu peuvent ignorer cette option.';
$lang['admin']['close'] = 'Fermer';
$lang['admin']['revert'] = 'Annuler toutes les modifications';
$lang['admin']['autoclearcache2'] = 'Effacer automatiquement les fichiers mis en cache qui sont plus anciens que le nombre de jour d&eacute;fini&nbsp;';
$lang['admin']['root'] = 'Racine';
$lang['admin']['info_content_autocreate_flaturls'] = 'Si Oui, toutes les URLs seront cr&eacute;es comme une copie de l&#039;alias de page (mais non synchronis&eacute;es avec l&#039;alias de page)';
$lang['admin']['content_autocreate_flaturls'] = 'Cr&eacute;er automatiquement les URL courtes&nbsp;';
$lang['admin']['content_autocreate_urls'] = 'Cr&eacute;er automatiquement les URLs des pages&nbsp;';
$lang['admin']['content_mandatory_urls'] = 'URLs des pages requises&nbsp;';
$lang['admin']['content_imagefield_path'] = 'Chemin pour les champs images&nbsp;';
$lang['admin']['info_content_imagefield_path'] = 'En relatif du chemin /uploads/images/, sp&eacute;cifier un nom de dossier contenant les fichiers images';
$lang['admin']['content_thumbnailfield_path'] = 'Chemin pour les champs vignettes images&nbsp;';
$lang['admin']['info_content_thumbnailfield_path'] = 'En relatif du chemin /uploads/images/, sp&eacute;cifier un nom de dossier contenant les fichiers vignettes images. Normalement il doit &ecirc;tre le m&ecirc;me que les fichiers images.';
$lang['admin']['contentimage_path'] = '&#039;Chemin pour la balise {content_image}&nbsp;';
$lang['admin']['info_contentimage_path'] = 'En relatif du chemin /uploads/, sp&eacute;cifier un nom de dossier contenant les fichiers pour la balise {content_image}. Cette valeur devient par d&eacute;faut le param&egrave;tre &quot;dir&quot;';
$lang['admin']['editcontent_settings'] = 'Param&egrave;tres des contenus';
$lang['admin']['help_page_url'] = 'Sp&eacute;cifie une URL alternative (relative &agrave; la racine du site WEB) qui peut &ecirc;tre utilis&eacute;e pour uniquement identifier la page. Exemple : chemin/vers/mapage. Les URLs des pages sont utilisables si &quot;URL de page&quot; est actif.';
$lang['admin']['help_page_alias'] = 'Cet alias est utilis&eacute; comme une alternative &agrave; l&#039;ID de la page pour uniquement identifier la page. (Il doit &ecirc;tre unique pour toutes les pages). L&#039;alias est aussi utilis&eacute; pour assister la construction de l&#039;URL de la page';
$lang['admin']['help_page_searchable'] = 'Ce param&egrave;tre indique que le contenu sera index&eacute; par le module Search';
$lang['admin']['help_page_cachable'] = 'La performance peut &ecirc;tre augment&eacute;e par la mise en cache des pages. Toutefois, ne pas utiliser pour les pages dont le contenu peut changer selon des requ&ecirc;tes de base de donn&eacute;es.';
$lang['admin']['sitedownexcludeadmins'] = 'Exclure les administrateurs connect&amp;eacute; dans l&#039;administration&nbsp; ';
...
$lang['admin']['listcontent_settings'] = 'Param&egrave;tres de la liste des pages';
...
$lang['admin']['lctitle_url'] = 'Le suffix de l&#039;URL du contenu. Si activ&eacute;';
$lang['admin']['lctitle_template'] = 'Le gabarit s&eacute;lectionn&eacute; du contenu. Quelques contenus peuvent ne pas avoir de gabarit';
$lang['admin']['lctitle_owner'] = 'Le propri&eacute;taire du contenu';
$lang['admin']['lctitle_active'] = 'Indique si l&#039;&eacute;l&eacute;ment de contenu est actif. Inactif ne sera pas affich&eacute;.';
$lang['admin']['lctitle_default'] = 'Sp&eacute;cifier l&#039;&eacute;l&eacute;ment de contenu qui est accessible lorsque l&#039;URL racine est demand&eacute;. Un seul &eacute;l&eacute;ment peut &ecirc;tre par d&eacute;faut';
$lang['admin']['lctitle_move'] = 'Permet l&#039;organisation de votre hi&eacute;rarchie de contenu';
$lang['admin']['lctitle_multiselect'] = 'Tous/Aucun';
$lang['admin']['invalid_url'] = 'L&#039;URL sp&eacute;cifi&eacute;e est invalide.  Elle ne doit contenir que des caract&egrave;res alphanum&eacute;riques, ou - ou encore /. Il est aussi possible que cette URL soit d&eacute;j&agrave; utilis&eacute;e.';
$lang['admin']['page_url'] = 'URL de page&nbsp;';
$lang['admin']['runuserplugin'] = 'Ex&eacute;cuter ce plugin utilisateur';
$lang['admin']['output'] = 'Sortie';
$lang['admin']['run'] = 'Ex&eacute;cuter';
$lang['admin']['run_udt'] = 'Ex&eacute;cuter cette balise utilisateur';
...
<p>Certains modules peuvent d&eacute;finir quel type de bloc de contenu sera utilis&eacute; dans les gabarits des modules. Par exemple, le module FrontEndUsers pourrait d&eacute;terminer un type de bloc de contenu pour la liste des groupes. il vous sera alors indiqu&eacute; comment vous pourrez utiliser la balise content_module pour ins&eacute;rer ce type de bloc de contenu &agrave; l&#039;int&eacute;rieur de vos gabarits/p>
...
$lang['admin']['info_estrict_failed'] = 'Certaines biblioth&egrave;ques que CMSMS&trade; utilise ne fonctionnent pas bien avec E_STRICT. Merci de d&eacute;sactiver avant de continuer';
...
$lang['admin']['invalidemail'] = 'L&#039;adresse de courriel entr&eacute;e est invalide !';
...
$lang['admin']['checksumdescription'] = 'V&eacute;rifier l&#039;int&eacute;grit&eacute; des fichiers de CMS Made Simple&trade; par comparaison avec le contr&ocirc;le (checksums)';
...
$lang['admin']['warning_upgrade'] = '<em><strong>ATTENTION</strong></em>&nbsp;: CMSMS&trade; a besoin d&#039;une mise &agrave; niveau - Le dossier /install doit &ecirc;tre pr&eacute;sent !';
...
$lang['admin']['help_systeminformation'] = 'Les informations affich&eacute;es ci-dessous sont collect&eacute;es depuis diff&eacute;rents endroits, et permettent d&#039;informer pour un diagnostic ou une aide sur l&#039;installation de CMS Made Simple&trade;.';
...
$lang['admin']['new_version_available'] = '<em>Remarque :</em> Une nouvelle version de CMS Made Simple&trade; est disponible. Informez-en votre administrateur.';
...
<p><span style=&quot;color: #ff0000;&quot;>ATTENTION ce plugin est obsol&egrave;te</span> et sera supprim&eacute; des versions futures de CMSMS&trade;.</p>
...
<code>{metadata}</code> est bien dans votre gabarit de page.</li>
	...
	<p>Ajouter le code suivant dans votre feuille de style CSS :</p>
        ...
        <h3>Quels param&egrave;tres ?</h3>
        <ul>
            <li>(requis)</em> url - l&#039;URL &agrave; inclure</li> 
...
$lang['admin']['help_function_contact_form'] = '  <h2 style=&quot;color: red;&quot;>ATTENTION ce plugin est obsol&egrave;te.</h2>
<h3>Cette balise est obsol&egrave;te et supprim&eacute;e depuis la version CMS Made Simple&trade; 1.5. </h3>
...
$lang['admin']['help_function_cms_versionname'] = '	<h3>Que fait cette Balise ?</h3>
	<p>Cette balise est utilis&eacute;e pour ins&eacute;rer le nom de version du CMS dans votre gabarit ou votre page. Elle n&#039;affiche rien d&#039;autre que le nom de la version.</p>
	<h3>Comment l&#039;utiliser ?</h3>
	<p>Ins&eacute;rer la balise dans votre page ou votre gabarit : <code>{cms_versionname}</code></p>
	<h3>Quels param&egrave;tres ?</h3>
	<p>Il n&#039;y a besoin d&#039;aucun param&egrave;tre.</p>';
$lang['admin']['help_function_cms_version'] = '	<h3>Que fait cette Balise ?</h3>
	<p>Cette balise est utilis&eacute; pour ins&eacute;rer le num&eacute;ro de la version courante du CMS dans votre page ou votre gabarit. Il n&#039;affiche rien d&#039;autre que le num&eacute;ro de version.</p>
	<h3>Comment l&#039;utiliser ?</h3>
...
$lang['admin']['help_function_cms_selflink'] = '		<h3>Que fait cette Balise ?</h3>
		<p>Cr&eacute;e un lien vers une autre page de contenu de CMSMS&trade; l&#039;int&eacute;rieur de votre gabarit ou de votre contenu. Peut aussi &ecirc;tre utilis&eacute; pour les liens externes avec le param&egrave;tre &quot;ext&quot;.</p>
		<h3>Comment l&#039;utiliser ?</h3>
...
$lang['admin']['event_help_moduleupgraded'] = '<p>Envoy&eacute; apr&egrave;s qu&#039;un module soit mis &agrave; jour.</p>';
$lang['admin']['event_desc_moduleinstalled'] = 'Envoy&eacute; apr&egrave;s l&#039;installation d&#039;un module';
$lang['admin']['event_help_moduleinstalled'] = '<p>Envoy&eacute; apr&egrave;s qu&#039;un module soit install&eacute;.</p>';
$lang['admin']['event_desc_moduleuninstalled'] = 'Envoy&eacute; apr&egrave;s la d&eacute;sinstallation d&#039;un module';
$lang['admin']['event_help_moduleuninstalled'] = '<p>Envoy&eacute; apr&egrave;s qu&#039;un module soit d&eacute;sinstall&eacute;.</p>';
$lang['admin']['event_desc_edituserdefinedtagpost'] = 'Envoy&eacute; apr&egrave;s la mise &agrave; jour d&#039;une balise utilisateur';
$lang['admin']['event_help_edituserdefinedtagpost'] = '<p>Envoy&eacute; apr&egrave;s la mise &agrave; jour d&#039;une balise utilisateur.</p>';
$lang['admin']['event_desc_edituserdefinedtagpre'] = 'Envoy&eacute; avant la mise &agrave; jour d&#039;une balise utilisateur';
$lang['admin']['event_help_edituserdefinedtagpre'] = '<p>Envoy&eacute; avant la mise &agrave; jour d&#039;une balise utilisateur.</p>';
$lang['admin']['event_desc_deleteuserdefinedtagpre'] = 'Envoy&eacute; avant qu&#039;une balise utilisateur ne soit supprim&eacute;e';
$lang['admin']['event_help_deleteuserdefinedtagpre'] = '<p>Envoy&eacute; avant qu&#039;une balise utilisateur ne soit supprim&eacute;e.</p>';
$lang['admin']['event_desc_deleteuserdefinedtagpost'] = 'Envoy&eacute; apr&egrave;s qu&#039;une balise utilisateur soit supprim&eacute;e';
$lang['admin']['event_help_deleteuserdefinedtagpost'] = '<p>Envoy&eacute; apr&egrave;s qu&#039;une balise utilisateur soit supprim&eacute;e.</p>';
...
$lang['admin']['event_help_adduserdefinedtagpre'] = '<p>Envoy&eacute; apr&egrave;s qu&#039;une balise utilisateur soit ins&eacute;r&eacute;e.</p>';
$lang['admin']['event_desc_adduserdefinedtagpre'] = 'Envoy&eacute; avant qu&#039;une balise utilisateur soit supprim&eacute;e';
$lang['admin']['event_help_adduserdefinedtagpost'] = '<p>Envoy&eacute; avant qu&#039;une balise utilisateur soit supprim&eacute;e.</p>';
...
$lang['admin']['adminpaneltitle'] = 'Connexion administration de CMS Made Simple&trade;';
...
$lang['admin']['logintitle'] = 'Administration de CMS Made Simple&trade;';
...
$lang['admin']['minimumversionrequired'] = 'Version minimale requise de CMSMS&trade;';
$lang['admin']['maximumversion'] = 'Version maximale';
$lang['admin']['maximumversionsupported'] = 'Version maximale de CMSMS&trade; support&eacute;e';
...
$lang['admin']['moduledescription'] = 'Les modules &eacute;tendent CMS Made Simple&trade; pour vous procurer toutes sortes de fonctionnalit&eacute;s personnalis&eacute;es.';
...
$lang['admin']['adminprefs'] = 'Pr&eacute;f&eacute;rences du compte utilisateur';
$lang['admin']['adminprefsdescription'] = 'R&eacute;glages des pr&eacute;f&eacute;rences de mon compte pour le panneau d&#039;administration. ';
$lang['admin']['managebookmarksdescription'] = 'Gestion des favoris de la console d&#039;administration.';
...
$lang['admin']['qca'] = 'P0-1868798862-1289915740206';
$lang['admin']['utmz'] = '156861353.1290510537.13.10.utmcsr=google|utmccn=(organic)|utmcmd=organic|utmctr=cmsms';
$lang['admin']['utma'] = '156861353.1598479872.1289915740.1290517279.1290527893.15';
