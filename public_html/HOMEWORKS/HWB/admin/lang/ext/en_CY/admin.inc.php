<?php
$lang['admin']['info_target'] = 'Gall dewis hwn a ddefnyddir gan y Rheolwr Ddewislen i ddangos pryd a sut y dylid fframiau ffenestri newydd neu gael ei hagor. Mae rhai rheolwr menu templedi anwybyddu&#039;r gall yr opsiwn hwn.';
$lang['admin']['close'] = 'Cau';
$lang['admin']['revert'] = 'Dychwelyd holl newidiadau';
$lang['admin']['autoclearcache2'] = 'Dileu ffeiliau cache sy&#039;n hŷn na&#039;r nifer penodol o ddyddiau.';
$lang['admin']['nothingtodo'] = 'Dim byd i&#039;w wneud!';
$lang['admin']['root'] = 'Root';
$lang['admin']['info_content_autocreate_flaturls'] = 'Wedi&#039;i alluogi, bydd pob urls yn cael ei greu fel copi o&#039;r dudalen arallenw (ond nid cydamseru i&#039;r dudalen arallenw)';
$lang['admin']['content_autocreate_flaturls'] = 'Mi fydd URL sy&#039;n cael eu creu yn awtomatig yn fflat ';
$lang['admin']['content_autocreate_urls'] = 'Creu URL tudalen yn awtomatig ';
$lang['admin']['content_mandatory_urls'] = 'Mae URL Tudalen yn angenrheidiol';
$lang['admin']['content_imagefield_path'] = 'Llwybr ar gyfer maes Lluniau';
$lang['admin']['info_content_imagefield_path'] = 'Gymharu &acirc;&#039;r ddelwedd llwythiad llwybr, nodwch enw cyfeiriadur sy&#039;n cynnwys y llwybrau sy&#039;n cynnwys ffeiliau ar gyfer y maes ddelwedd';
$lang['admin']['content_thumbnailfield_path'] = 'Llwybr ar gyfer Thumbnail Lluniau';
$lang['admin']['info_content_thumbnailfield_path'] = 'Gymharu &acirc;&#039;r ddelwedd llwythiad llwybr, nodwch enw cyfeiriadur sy&#039;n cynnwys y llwybrau sy&#039;n cynnwys ffeiliau ar gyfer y maes ddelwedd. Fel arfer bydd hyn yn cael yr un fath &acirc;&#039;r llwybr uchod.';
$lang['admin']['contentimage_path'] = 'Llwybr ar gyfer {content_image} tag';
$lang['admin']['info_contentimage_path'] = 'Gymharu &acirc;&#039;r llwybr llwythiad, nodwch enw cyfeiriadur sy&#039;n cynnwys y llwybrau sy&#039;n cynnwys ffeiliau ar gyfer y tag {content_image}. Y gwerth hwn yn cael ei ddefnyddio fel diofyn ar gyfer y paramedr dir';
$lang['admin']['editcontent_settings'] = 'Gosodiadau Golygu Cynnwys';
$lang['admin']['help_page_url'] = 'Penodwch URL arall (o&#039;i gymharu &acirc; gwraidd eich gwefan) y gellir eu defnyddio i adnabod y dudalen hon yn unigryw. h.y: llwybr / i / tutadlenhon. Mae&#039;r URL y dudalen ond yn defnyddiol pan mae URLS bert yn cael eu galluogi.';
$lang['admin']['help_page_alias'] = 'Mae&#039;r alias cael ei ddefnyddio fel ail i&#039;r dudalen id i adnabod unigryw dudalen. Rhaid iddo fod yn unigryw ar draws pob tudalen. Mae&#039;r alias cael ei ddefnyddio hefyd i helpu i adeiladu URL ar gyfer y dudalen';
$lang['admin']['help_page_searchable'] = 'Mae&#039;r gosodiad hwn yn nodi a ddylid cynnwys y dudalen hon yn cael ei fynegeio gan y modiwl Chwilio';
$lang['admin']['help_page_cachable'] = 'Gellir gynyddu perfformiad drwy osod cyn gymain o tudalennau &acirc; phosibl i cachable. Fodd bynnag, ni all hyn gael ei ddefnyddio ar gyfer tudalennau lle gall gynnwys newid ar sail fesul gais';
$lang['admin']['sitedownexcludeadmins'] = 'Eithriwch defnyddwyr wedi mewngofnodi i&#039;r ardal rheoli o fewn CMSMS ';
$lang['admin']['your_ipaddress'] = 'Eidh cyfeiriad IP';
$lang['admin']['use_wysiwyg'] = 'Defnyddiwch WYSIWYG';
$lang['admin']['contenttype_redirlink'] = 'Ailgyfeirio Linc';
$lang['admin']['yes'] = 'Ie';
$lang['admin']['no'] = 'Na';
$lang['admin']['listcontent_showalias'] = 'Dangoswch y colofn &quot;Alias&quot;';
$lang['admin']['listcontent_showurl'] = 'Dangoswch y colofn &quot;URL&quot;';
$lang['admin']['listcontent_showtitle'] = 'Dangoswch Teitl y tudalen new Testun y Ddewislen';
$lang['admin']['listcontent_settings'] = 'Gosodiadau Rhestr Cynnwys ';
$lang['admin']['lctitle_page'] = 'Teitl presennol yr eitemau cynnwys';
$lang['admin']['lctitle_alias'] = 'Arallenw o eitemau cynnwys presennol. Nid oes arallenw gan rhai eitemau cynnwys';
$lang['admin']['lctitle_url'] = 'Y URL &ocirc;l-ddodiad ar gyfer yr eitem cynnwys. Os wedi ei osod ';
$lang['admin']['lctitle_template'] = 'Mae&#039;r templed a ddewiswyd ar gyfer yr eitem cynnwys. Nid oes templedi gan rhai eitemau cynnwys';
$lang['admin']['lctitle_owner'] = 'Perchennog yr eitem gynnwys ';
$lang['admin']['lctitle_active'] = 'Yn dangos a yw&#039;r eitem cynnwys yn weithredol. Ni ellir eitemau anweithgar cael eu harddangos.';
$lang['admin']['lctitle_default'] = 'Nodwch yr eitem cynnwys sy&#039;n cael eu defnyddio pan fydd y url gwraidd yn gofynnir amdani. Dim ond un eitem yn ddiofyn';
$lang['admin']['lctitle_move'] = 'Yn caniat&aacute;u i drefnu hierarchaeth eich cynnwys';
$lang['admin']['lctitle_multiselect'] = 'Dewis Pobeth/Dim';
$lang['admin']['invalid_url'] = 'Mae URL y dudalen penodedig yn annilys. Dylid cynnwys dim ond llythrennau alffaniwmerig, neu - neu /. Mae hefyd yn bosibl bod yr URL a nodwyd eisoes yn cael ei ddefnyddio.';
$lang['admin']['page_url'] = 'URL y Tudalen';
$lang['admin']['runuserplugin'] = 'Rhedwch Ategyn Defnyddiwr';
$lang['admin']['output'] = 'Allbwn';
$lang['admin']['run'] = 'Rhedwch';
$lang['admin']['run_udt'] = 'Rhedwch y User Defined Tag yma';
$lang['admin']['stylesheetcopied'] = 'Taflen Arddull wedi eu gopio';
$lang['admin']['templatecopied'] = 'Templed wedi eu gopio';
$lang['admin']['ecommerce_desc'] = 'Modiwlau ar gyfer darparu galluoedd e-fasnach ';
$lang['admin']['ecommerce'] = 'E-Fasnach';
$lang['admin']['help_function_content_module'] = '<h3> Beth mae hyn yn ei wneud? </ H3>

<p>Mae&#039;r math hyn o bloc cynnwys yn galluogi rhyngwynebu gyda modiwlau gwahanol i greu mathau bloc cynnwys gwahanol. </ p>

Gall <p> rhai modiwlau diffinio&#039;r mathau bloc gynnwys i&#039;w ddefnyddio mewn modiwl templates. hy: Efallai y bydd y modiwl FrontEndUsers yn diffinio grwp bloc rhestr fath gynnwys. Yna, bydd yn dangos sut y gallwch ddefnyddio y tag content_module i ddefnyddio&#039;r math hyn o floc o fewn eich templates. </ p>

<p> <strong> Nodyn: </ strong> Rhaid bod bloc y math hwn ond cael ei ddefnyddio gyda modiwlau gydnaws. Ni ddylech ddefnyddio hyn mewn unrhyw ffordd ac eithrio fel y harwain gan modiwlau ychwanegol. </ p>
...
$lang['admin']['qca'] = 'P0-1616678321-1262603060110';
$lang['admin']['utmz'] = '156861353.1287489336.33.6.utmcsr=wiki.cmsmadesimple.org|utmccn=(referral)|utmcmd=referral|utmcct=/index.php/Special:Search';
$lang['admin']['utma'] = '156861353.1150550259.1285890669.1287832831.1287840774.48';
