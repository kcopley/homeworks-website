	...
	case "add":
		$bar1 = $_REQUEST['bar1'];
			$bar1str = "SELECT post_id
				...
				GROUP BY post_id;
			";
			$bar1_id = explode(",",$wpdb->get_var($wpdb->prepare($bar1str))); 
			$bar1id = $bar1_id[0];
		...
		$bar2 = $_REQUEST['bar2'];
			$bar2str = "SELECT post_id
				...
				GROUP BY post_id;
			";
			$bar2_id = explode(",",$wpdb->get_var($wpdb->prepare($bar2str))); 
			$bar2id = $bar2_id[0];
		...
		$bar3 = $_REQUEST['bar3'];
			$bar3str = "SELECT post_id
				...
				GROUP BY post_id;
			";
			$bar3_id = explode(",",$wpdb->get_var($wpdb->prepare($bar3str))); 
			$bar3id = $bar3_id[0];
		...
		$bar4 = $_REQUEST['bar4'];
			$bar4str = "SELECT post_id
				...
				GROUP BY post_id;
			";
			$bar4_id = explode(",",$wpdb->get_var($wpdb->prepare($bar4str))); 
			$bar4id = $bar4_id[0];
		...
		$bar5 = $_REQUEST['bar5'];
			$bar5str = "SELECT post_id
				...
				GROUP BY post_id;
			";
			$bar5_id = explode(",",$wpdb->get_var($wpdb->prepare($bar5str))); 
			$bar5id = $bar5_id[0];
		...
		$bar6 = $_REQUEST['bar6'];
			$bar6str = "SELECT post_id
				...
				GROUP BY post_id;
			";
			$bar6_id = explode(",",$wpdb->get_var($wpdb->prepare($bar6str))); 
			$bar6id = $bar6_id[0];
		...
		$bar7 = $_REQUEST['bar7'];
			$bar7str = "SELECT post_id
				...
				GROUP BY post_id;
			";
			$bar7_id = explode(",",$wpdb->get_var($wpdb->prepare($bar7str))); 
			$bar7id = $bar7_id[0];
		...
		$bar8 = $_REQUEST['bar8'];
			$bar8str = "SELECT post_id
				...
				GROUP BY post_id;
			";
			$bar8_id = explode(",",$wpdb->get_var($wpdb->prepare($bar8str))); 
			$bar8id = $bar8_id[0];
		...
		$bar9 = $_REQUEST['bar9'];
			$bar9str = "SELECT post_id
				...
				GROUP BY post_id;
			";
			$bar9_id = explode(",",$wpdb->get_var($wpdb->prepare($bar9str))); 
			$bar9id = $bar9_id[0];
		...
		$bar10 = $_REQUEST['bar10'];
			$bar10str = "SELECT post_id
				...
				GROUP BY post_id;
			";
			$bar10_id = explode(",",$wpdb->get_var($wpdb->prepare($bar10str))); 
			$bar10id = $bar10_id[0];
		...
		$bar11 = $_REQUEST['bar11'];
			$bar11str = "SELECT post_id
				...
				GROUP BY post_id;
			";
			$bar11_id = explode(",",$wpdb->get_var($wpdb->prepare($bar11str))); 
			$bar11id = $bar11_id[0];
		...
		$bar12 = $_REQUEST['bar12'];
			$bar12str = "SELECT post_id
				...
				GROUP BY post_id;
			";
			$bar12_id = explode(",",$wpdb->get_var($wpdb->prepare($bar12str))); 
			$bar12id = $bar12_id[0];
		...
		$bar13 = $_REQUEST['bar13'];
			$bar13str = "SELECT post_id
				...
				GROUP BY post_id;
			";
			$bar13_id = explode(",",$wpdb->get_var($wpdb->prepare($bar13str))); 
			$bar13id = $bar13_id[0];
		...
		$bar14 = $_REQUEST['bar14'];
			$bar14str = "SELECT post_id
				...
				GROUP BY post_id;
			";
			$bar14_id = explode(",",$wpdb->get_var($wpdb->prepare($bar14str))); 
			$bar14id = $bar14_id[0];
		...
		$bar15 = $_REQUEST['bar15'];
			$bar15str = "SELECT post_id
				...
				GROUP BY post_id;
			";
			$bar15_id = explode(",",$wpdb->get_var($wpdb->prepare($bar15str))); 
			$bar15id = $bar15_id[0];
		...
		$bar16 = $_REQUEST['bar16'];
			$bar16str = "SELECT post_id
				...
				GROUP BY post_id;
			";
			$bar16_id = explode(",",$wpdb->get_var($wpdb->prepare($bar16str))); 
			$bar16id = $bar16_id[0];
		...
		$bar17 = $_REQUEST['bar17'];
			$bar17str = "SELECT post_id
				...
				GROUP BY post_id;
			";
			$bar17_id = explode(",",$wpdb->get_var($wpdb->prepare($bar17str))); 
			$bar17id = $bar17_id[0];
		...
		$bar18 = $_REQUEST['bar18'];
			$bar18str = "SELECT post_id
				...
				GROUP BY post_id;
			";
			$bar18_id = explode(",",$wpdb->get_var($wpdb->prepare($bar18str))); 
			$bar18id = $bar18_id[0];
		...
		$bar19 = $_REQUEST['bar19'];
			$bar19str = "SELECT post_id
				...
				GROUP BY post_id;
			";
			$bar19_id = explode(",",$wpdb->get_var($wpdb->prepare($bar19str))); 
			$bar19id = $bar19_id[0];
		...
		$bar20 = $_REQUEST['bar20'];
			$bar20str = "SELECT post_id
				...
				GROUP BY post_id;
			";
			$bar20_id = explode(",",$wpdb->get_var($wpdb->prepare($bar20str))); 
			$bar20id = $bar20_id[0];
		...
		$bar21 = $_REQUEST['bar21'];
			$bar21str = "SELECT post_id
				...
				GROUP BY post_id;
			";
			$bar21_id = explode(",",$wpdb->get_var($wpdb->prepare($bar21str))); 
			$bar21id = $bar21_id[0];
		...
		$bar22 = $_REQUEST['bar22'];
			$bar22str = "SELECT post_id
				...
				GROUP BY post_id;
			";
			$bar22_id = explode(",",$wpdb->get_var($wpdb->prepare($bar22str))); 
			$bar22id = $bar22_id[0];
		...
		$bar23 = $_REQUEST['bar23'];
			$bar23str = "SELECT post_id
				...
				GROUP BY post_id;
			";
			$bar23_id = explode(",",$wpdb->get_var($wpdb->prepare($bar23str))); 
			$bar23id = $bar23_id[0];
		...
		$bar24 = $_REQUEST['bar24'];
			$bar24str = "SELECT post_id
				...
				GROUP BY post_id;
			";
			$bar24_id = explode(",",$wpdb->get_var($wpdb->prepare($bar24str))); 
			$bar24id = $bar24_id[0];
		...
		$bar25 = $_REQUEST['bar25'];
			$bar25str = "SELECT post_id
				...
				GROUP BY post_id;
			";
			$bar25_id = explode(",",$wpdb->get_var($wpdb->prepare($bar25str))); 
			$bar25id = $bar25_id[0];
		...
		$bar26 = $_REQUEST['bar26'];
			$bar26str = "SELECT post_id
				...
				GROUP BY post_id;
			";
			$bar26_id = explode(",",$wpdb->get_var($wpdb->prepare($bar26str))); 
			$bar26id = $bar26_id[0];
		...
		$bar27 = $_REQUEST['bar27'];
			$bar27str = "SELECT post_id
				...
				GROUP BY post_id;
			";
			$bar27_id = explode(",",$wpdb->get_var($wpdb->prepare($bar27str))); 
			$bar27id = $bar27_id[0];
		...
		$bar28 = $_REQUEST['bar28'];
			$bar28str = "SELECT post_id
				...
				GROUP BY post_id;
			";
			$bar28_id = explode(",",$wpdb->get_var($wpdb->prepare($bar28str))); 
			$bar28id = $bar28_id[0];
		...
		$bar29 = $_REQUEST['bar29'];
			$bar29str = "SELECT post_id
				...
				GROUP BY post_id;
			";
			$bar29_id = explode(",",$wpdb->get_var($wpdb->prepare($bar29str))); 
			$bar29id = $bar29_id[0];
		...
		$bar30 = $_REQUEST['bar30'];
			$bar30str = "SELECT post_id
				...
				GROUP BY post_id;
			";
			$bar30_id = explode(",",$wpdb->get_var($wpdb->prepare($bar30str))); 
			$bar30id = $bar30_id[0];
