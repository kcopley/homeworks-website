	...
	<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
		...
		<form id="TRANSFIRST" method="POST" action="https://webservices.primerchants.com/billing/TransactionCentral/processCC.asp?" name="frmReturn" id="frmReturn">
			...
			<?php }; ?>
                        ...
                        <input type="hidden" name="AccountNo" value="<?php echo $_REQUEST['billingCard1'];?><?php echo $_REQUEST['billingCard2'];?><?php echo $_REQUEST['billingCard3'];?><?php echo $_REQUEST['billingCard4'];?>">
