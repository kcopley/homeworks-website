<?php
$lang['set_cachable'] = 'Nastavi to predlogo kot cachable';
$lang['help_nocache'] = 'Onemogoči vse predpomnjenje tega razpisa v meni. Ta parameter, če je nastavljen za vsako pozitivno vrednost prepi&scaron;e vse nastavitve v vsebini predmeta in meni predlogi.';
$lang['cachable'] = 'Cachable';
$lang['help_childrenof'] = 'Ta možnost bo prikazala v meniju le predmete, ki so potomci izbranih id stran ali psevdonimov.  Naprimer: S <code>{menu childrenof=$page_alias}</code> bodo prikazani samo otroci trenutne strani.';
$lang['usage'] = 'Uporaba';
$lang['help_loadprops'] = 'Uporabite ta parameter pri uporabi naprednih možnosti v va&scaron;i predlogi menija. Parameter bo prisilil nalaganje vseh lastnosti vsebine za vse elemente (kot npr. extra1, slika, pomanj&scaron;ava, itd.) in bo zelo povečal &scaron;tevilo SQL zahtev v ozadju. To povi&scaron;a porabo spomina, vendar pa omogoča izdelavo bolj naprednih menijev.';
$lang['readonly'] = 'samo za branje';
$lang['error_templatename'] = 'Ne morete določiti ime predloge s končnico .tpl';
$lang['this_is_default'] = 'Privzeta predloga menija';
$lang['set_as_default'] = 'Nastavi kot privzeto predlogo menija';
