<?php
$lang['error_uploadpermissions'] = '<strong>WAARSCHUWING:</strong> U heeft onvoldoende rechten om thema&#039;s te uploaden of te installeren. Het kan een rechten probleem zijn van de Uploads- of de Modules map. Ook kan de PHP Safe Mode op de server ingeschakeld zijn.';
...
$lang['error_nofilesuploaded'] = 'Geen bestanden ge&uuml;pload. Zorg ervoor dat de form tag&#039;s enctype is ingesteld op multipart/form-data en dat het juiste veld voor het geuploade bestand is aangevinkt.';
...
$lang['import_succeeded'] = 'De theme is succesvol ge&iuml;mporteerd';
