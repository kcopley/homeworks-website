...
$lang['moddescription'] = 'Modul umožňuj&iacute;c&iacute; import a export t&eacute;mat obsahu ( &scaron;ablon a stylů)';
$lang['import_succeeded'] = 'T&eacute;ma bylo &uacute;spě&scaron;ně importov&aacute;no';
$lang['help'] = '<h3>Co tento modul děl&aacute;?</h3>
<p>Tento modul v&aacute;m umožňuje importovat a exportovat &scaron;ablony a k nim připojen&eacute; styly jako &quot;t&eacute;mata&quot;.  To umožňuje sd&iacute;let svůj vzhled s ostatn&iacute;mi uživateli cms.</p
...
<p>Podle GPL licence je tento software poskytov&aacute;n tak-jak-je. Pro pln&eacute; odvol&aacute;n&iacute; si pros&iacute;m přečtěte text GPL licence.</p>
