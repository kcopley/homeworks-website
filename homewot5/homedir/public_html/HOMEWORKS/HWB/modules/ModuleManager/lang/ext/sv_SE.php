<?php
$lang['search_noresults'] = 'Din s&ouml;kning lyckades men inga resultat matchade';
$lang['advancedsearch_help'] = 'Ange ord att inkludera eller utesluta fr&aring;n s&ouml;kningen med ett + eller -, exakta fraser med citationstecken. I.E: &quot;+ r&ouml;da -&auml;pple +&quot; n&aring;gon text &quot;';
$lang['search_results'] = 'S&ouml;kresultat';
$lang['prompt_advancedsearch'] = 'Avancerad s&ouml;kning';
$lang['search_input'] = 'S&ouml;kinmatning';
$lang['searchterm'] = 'S&ouml;kterm';
$lang['search'] = 'S&ouml;k';
$lang['error_searchterm'] = 'V&auml;nligen ange n&aring;got giltigt f&ouml;r att s&ouml;ka';
$lang['available_updates'] = 'Moduler tillg&auml;ngliga f&ouml;r uppdatering';
$lang['all_modules_up_to_date'] = 'Det finns inga nyare moduler tillg&auml;ngliga som finns i arkivet';
$lang['error_module_object'] = 'Fel: kunde inte f&aring; en instans av %s modulen';
$lang['error_nomatchingmodules'] = 'Fel: Kunde inte hitta n&aring;gra matchande moduler i arkivet';
$lang['error_nomodules'] = 'Fel: Kunde inte h&auml;mta lista med installerade moduler';
$lang['upgrade_available'] = 'Nyare verson tillg&auml;nglig (%s), du har (%s)';
...
$lang['depend_upgrade'] = 'Modulen %s beh&ouml;ver uppgraderas till version %s.';
$lang['depend_install'] = 'Modul %s (version %s eller senare) m&aring;ste installeras.';
$lang['depend_activate'] = 'Modulen %s m&aring;ste aktiveras.';
$lang['action_activated'] = 'Modulen %s &auml;r nu aktiverad.';
$lang['action_installed'] = 'Modulen %s har installerats med f&ouml;ljande meddelande(n): %s';
$lang['action_upgraded'] = 'Modulen %s &auml;r nu uppgraderad';
$lang['title_installation_complete'] = 'Installationen &auml;r f&auml;rdig!';
$lang['install_with_deps'] = 'Utv&auml;rdera alla beroenden och installera';
$lang['msg_nodependencies'] = 'Filen har inte listat n&aring;gra beroenden';
$lang['error_upgrade'] = 'Uppgraderingen av modulen %s misslyckades!';
$lang['error_skipping'] = 'Hoppar &ouml;ver installation/uppgradering av %s p&aring; grund av fel med beroenden. Se meddelande ovan, och f&ouml;rs&ouml;k igen.';
$lang['dependstxt'] = 'Beroenden';
$lang['use_at_your_own_risk'] = 'Anv&auml;nd p&aring; egen risk';
$lang['compatibility_disclaimer'] = 'Modulerna som visas h&auml;r har bidragits av b&aring;de CMSMS-utvecklarna och oberoende tredjepartsutvecklare. Vi kan inte garantera att modulerna som finns tillg&auml;ngliga h&auml;r fungerar, &auml;r testade eller &auml;r kompatibla med ditt system. L&auml;s g&auml;rna informationen som finns i hj&auml;lpen och om-l&auml;nkarna f&ouml;r varje modul innan du installerar n&aring;got.';
$lang['notice'] = 'OBS!';
$lang['general_notice'] = 'Versionerna som visas h&auml;r representerar de senaste XML-filerna som har laddats upp till den lagringssplats som du har valt (vanligtvis CMS-%s). Det &auml;r inte s&auml;kert att de representerar de senast tillg&auml;ngliga versionerna. Du kan se vilka de tillg&auml;ngliga filutg&aring;vorna &auml;r f&ouml;r den lagringssplats som du har valt. Om du anv&auml;nder standardlagringsplatsen kan du g&ouml;ra detta genom att skriva in modulnamnet i s&ouml;krutan p&aring; %s och klicka p&aring; &quot;Filer-knappen&quot;.';
...
$lang['error_permissions'] = '<strong><em>VARNING:</em></strong> Otillr&auml;ckligt mappr&auml;ttigheter f&ouml;r att installera moduler. Det kan ocks&aring; vara s&aring; att du har problem med PHP Safe mode. Se till att safe mode &auml;r avst&auml;ngt och att filsystemr&auml;ttigheterna &auml;r tillr&auml;ckliga.';
...
$lang['preferencessaved'] = 'Inst&auml;llningar sparade';
...
$lang['time_warning'] = 'Installationslistan har tv&aring; eller fler moduler. Installationen kan ta ett par minuter. Ha t&aring;lamod!';
...
$lang['utmc'] = '156861353';
$lang['utmb'] = '156861353.1.10.1288031696';
?>