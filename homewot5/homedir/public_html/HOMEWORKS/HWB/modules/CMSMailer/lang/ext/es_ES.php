...
$lang['ssl'] = 'SSL ';
$lang['tls'] = 'TLS ';
$lang['secure'] = 'Mecanismo de encriptaci&oacute;n';
$lang['info_secure'] = 'S&oacute;lo se aplica al m&eacute;todo SMTP de env&iacute;o de correo, esta opci&oacute;n permite especificar diferentes mecanismos de cifrado para la conexi&oacute;n';
$lang['info_cmsmailer'] = 'Este m&oacute;dulo es usado por muchos otros m&oacute;dulos para facilitar el env&iacute;o de Emails. Debe estar configurado adecuadamente siguiendo los requisitos de su proveedor de alojamiento.  Por favor, use la informaci&oacute;n proporcionada por su proveedor de alojamiento para ajustar la configuraci&oacute;n. Si a&uacute;n as&iacute; no puede enviar el Email de prueba, seguramente tenga que solicitar ayuda a su proveedor de alojamiento.';
$lang['charset'] = 'Juego de Caracteres';
$lang['sendtestmailconfirm'] = 'Esto env&iacute;a un mensaje de prueba a la direcci&oacute;n especificada. Si el env&iacute;o se realiza con &eacute;xito, regresar&aacute;s a esta p&aacute;gina.  &iquest;Quieres continuar?';
$lang['settingsconfirm'] = '&iquest;Guardar los valores actuales de CMSMailer?';
$lang['testsubject'] = 'Mensaje de prueba de CMSMailer';
$lang['testbody'] = 'Este mensaje es s&oacute;lo para comprobar la validez de los valores del m&oacute;dulo CMSMailer.
...
$lang['mailer'] = 'M&eacute;todo de env&iacute;o';
$lang['host'] = 'Nombre de host SMTP<br/><i>(o direcci&oacute;n IP)</i>';
...
$lang['info_mailer'] = 'Protocolo a usar (sendmail, smtp, mail).  Normalmente SMTP es el m&aacute;s adecuado.';
...
$lang['info_from'] = 'Direcci&oacute;n que se usa como &#039;sender&#039; en todos los emails. <br/><strong>Nota</strong>, esta direcci&oacute;n de email tiene que ser la apropiada para su alojamiento o tendr&aacute; problemas al enviar emails.<br/>Si desconoce el valor adecuado necesitar&aacute; contactar con su proveedor de alojamiento.';
$lang['info_fromuser'] = 'Nombre amigable usado al enviar los mensajes';
$lang['info_sendmail'] = 'Ruta completa del ejectable sendmail (s&oacute;lo valido para el protocolo sendmailer)';
