...
if( isset($params['submit_template']) )
  {
    if( isset($params['error_template'] ) )
      $this->SetErrorTemplate(trim($params['error_template']));
...
if( $this->CheckPermission('Modify Templates') )
  {
    echo $this->SetTabHeader('sortablelists',
			     $this->Lang('sortablelist_templates'));
...
if ($this->CheckPermission('Modify Site Preferences'))
  {
    ...
    include(dirname(__FILE__).'/function.admin_generaltab.php');
    echo $this->EndTab();

    echo $this->StartTab('graphics',$params);
    echo $this->CreateFormStart($id,'defaultadmin',$returnid);
    include(dirname(__FILE__).'/function.admin_graphicstab.php');
    echo $this->EndTab();

    echo $this->StartTab('cache_settings');
    include(dirname(__FILE__).'/function.admin_cache_settings_tab.php');
    echo $this->EndTab();
...
if( $this->CheckPermission('Modify Templates') )
  {
    ...
    include(dirname(__FILE__).'/function.admin_sortablelists_tab.php');
    echo $this->EndTab();
