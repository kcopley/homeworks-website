...
class Codes extends Common
{
	...
	{
		$tableColumns['code'] = array('display_text' => 'Code', 'perms' => 'EVCTAXQSHO');
		...
		$this->Editor->setConfig('orderByColumn','code');
		$this->Editor->setConfig('addRowTitle','Add Code');
		$this->Editor->setConfig('editRowTitle','Edit Code');
		$this->Editor->setConfig('iconTitle','Edit Code');
	}
